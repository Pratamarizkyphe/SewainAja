                ...
                <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        @foreach ($penyewaans as $penyewaan)
                            <tr class="border-b border-gray-200 hover:bg-gray-300 {{$penyewaan->status_pembayaran == 'lunas'?'bg-green-100 ':'bg-red-100' }}">
                                ...
                                <td class="py-3 px-6 text-left">{{ $penyewaan->status_pembayaran == 'lunas'? 'Sudah Lunas' : 'Belum Dibayar' }}</td>
                                <td class="py-3 px-6 text-left flex">
                                    <a class="text-blue-500 mr-2" href="{{ route('user.detail-riwayat', $penyewaan->id) }}"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
