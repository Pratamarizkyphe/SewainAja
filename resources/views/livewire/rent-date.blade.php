<div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        @if($type === 'pribadi')
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="date" class="w-full border border-gray-300 rounded-md p-2 hover:border-gray-400 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" min="1" class="w-full border border-gray-300 rounded-md p-2 hover:border-gray-400 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50">
                </div>
            </div>
        @else
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div class="text-center mt-4">
        <button class="bg-purple-500 text-white py-2 px-6 rounded-full hover:bg-purple-600">Cari Mobil</button>
    </div>
</div>
